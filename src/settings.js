...
export const SETTINGS_SCHEMA = {
    ...
    UPDATE_INTERVAL: {
        ...
        max: 300000,
        group: "sync",
        label: "Slot update interval",
        description: "Milliseconds between two processed slot reports per printer. Covers the AMS slots and the external spool holder.",
    },
    SET_LOCATION: {
        type: "boolean",
        default: false,
        group: "sync",
        label: "Write slot as location",
        description: "Stores printer name and slot of the loaded spool as its location in Spoolman.",
    },
    ...
    MQTT_TRACE_MAX_SIZE_MB: {
        ...
        description: "Size a trace file may reach before it is rotated. A printer reports every few seconds and every report is a full document, so this is the setting that decides how far back a trace reaches.",
    },
    MQTT_TRACE_KEEP: {
        type: "integer",
        default: 2,
