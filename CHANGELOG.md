...
Version 1.3.0-dev
   - New Features:
      ...
      - Settings page in the Web UI: everything that used to be an environment variable can now be changed in the browser, plus the printer list
         ...
         - The log files are trimmed to their last 2000 lines once they pass 1 MB, checked on every start. Nothing truncated the per printer files before, they were created once and appended to forever
