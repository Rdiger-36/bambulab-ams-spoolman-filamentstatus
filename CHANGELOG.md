...
Version 1.3.0-dev.23
   - Fixes:
      - The dashboard no longer shows the whole plate as "booked" for a print cancelled before its first layer. The booking wrote 0 g and the spool was left alone, but the row under "Needed" fell back to the full amount when the used amount was 0; seen on a P2S on 2026-09-23 after a cancel at layer 0
