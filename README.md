...
1. You have to create or edit a spool in Spoolman
2. After entering all your necessary information you have to add en Extra Field called "tag"
3. In this new field you have to put in the seriel number from your spool and click on save.

![{8E6CD62B-BE4F-4F41-A3ED-1654B0FC9B69}](https://github.com/user-attachments/assets/3fd775c9-aa34-4c64-917d-ae4ddc713b9d)
...
5. the serial number, in this case ABCD1234, must be entered in Spoolman under the desired spool in the extra field “tag”
