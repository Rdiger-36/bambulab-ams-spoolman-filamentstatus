...
| Feature | ~~Custom filament selection via web~~ Add a "State" column that shows if the data is proceeded correctly or not and if not use the action button to show a info dialog, because sometimes the data of the AMS did not match with the official data from BambuLab (e.g. false color codes) | ❌ | ❌ | implemented, can be testet in next dev build (release soon), [Issue-22](https://github.com/Rdiger-36/bambulab-ams-spoolman-filamentstatus/issues/22) |
...
| Feature | Support for spoolman running in subfolder | ❌ | ❌ | implemented, can be testet in next dev build (release soon), [Issue-23](https://github.com/Rdiger-36/bambulab-ams-spoolman-filamentstatus/issues/23) |
...
| Feature | Processing and using multicolor filament and spools | ❌ | ❌ | implemented, can be testet in next dev build (release soon), [Issue-26](https://github.com/Rdiger-36/bambulab-ams-spoolman-filamentstatus/issues/26) |
...
| Feature | Add Link to Spoolman Integration and support FQDN with https | ❌ | ❌ | implemented, can be testet in next dev build (release soon) |
